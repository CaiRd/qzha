  ...
  <body>
    ...
    <div class="">
			...
			<!--=========== ABOUT SECTION ===========-->
				<section>
					<div class="bl-box">
						<h2>Hi Our Name is School IT</h2> <!-- class="bl-icon bl-icon-about" -->
					</div><!-- /bl-box -->
					<div class="bl-content">
						<div class="row-fluid">
							<div class="span12">
								<h2>关于 School IT 社</h2>
								<p>学校最早创立的四大社团之一.</p>
								...
								<div class="row-fluid">
									...
									<h2>Our Skills</h2>
										...
										<div class="progress">
										<div class="bar" style="width: 80%;">C#/ASP.NET 80%</div>
										</div>  
										<div class="progress">
										<div class="bar" style="width: 63%;">SQL Server 63%</div>
										</div> 
                                        <div class="progress">
										<div class="bar" style="width: 50%;">iOS APP Develop 503%</div>
										</div> 
										<!-- Progress Bar End --> 
									</div><!-- /span6 -->
									<div class="span4"></div>
